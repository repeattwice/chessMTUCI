...
namespace chessMTUCI {
	...
	/// <summary>
	/// —водка дл€ pawnFinaleBlack
	/// </summary>
	public ref class pawnFinaleBlack : public System::Windows::Forms::Form
	{
	public:
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(pawnFinaleBlack::typeid));
			...
			this->picQueen->InitialImage = nullptr;
			...
			this->picQueen->Click += gcnew System::EventHandler(this, &pawnFinaleBlack::picQueen_Click);
			this->picQueen->MouseEnter += gcnew System::EventHandler(this, &pawnFinaleBlack::picQueen_MouseEnter);
			// 
			// picBishop
			// 
			...
			this->picBishop->Click += gcnew System::EventHandler(this, &pawnFinaleBlack::picBishop_Click);
			this->picBishop->MouseEnter += gcnew System::EventHandler(this, &pawnFinaleBlack::picBishop_MouseEnter);
			// 
			// picRook
			// 
			...
			this->picRook->Click += gcnew System::EventHandler(this, &pawnFinaleBlack::picRook_Click);
			this->picRook->MouseEnter += gcnew System::EventHandler(this, &pawnFinaleBlack::picRook_MouseEnter);
			// 
			// picKnight
			// 
			...
			this->picKnight->Click += gcnew System::EventHandler(this, &pawnFinaleBlack::picKnight_Click);
			this->picKnight->MouseEnter += gcnew System::EventHandler(this, &pawnFinaleBlack::picKnight_MouseEnter);
			// 
			// pawnFinaleBlack
			// 
			...
			this->Name = L"pawnFinaleBlack";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"pawnFinaleBlack";
